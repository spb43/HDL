...
HD_PWD='D:/code_test/HDL/vivado/comparator/comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator.vdi -applog -m64 -messageDb vivado.pb -mode batch -source comparator.tcl -notrace
