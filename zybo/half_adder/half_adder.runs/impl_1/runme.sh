...
HD_PWD='D:/code_test/HDL/vivado/half_adder/half_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log h_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source h_adder.tcl -notrace
