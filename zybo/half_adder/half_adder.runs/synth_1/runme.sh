...
HD_PWD='D:/code_test/HDL/vivado/half_adder/half_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source h_adder.tcl
