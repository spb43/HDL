...
TOP_LEVEL_NAME="alt_clk_div"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/spb/altera/15.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/alt_clk_div_altclkctrl_0.vhd" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/alt_clk_div.vhd"                                                                                   
fi
