...
# ACDS 15.0 145 linux 2016.11.16.13:45:21
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "alt_clk_div"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/spb/altera/15.0/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/submodules/alt_clk_div_altclkctrl_0.vhd" -work altclkctrl_0
  vcom "$QSYS_SIMDIR/alt_clk_div.vhd"                                           
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altclkctrl_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altclkctrl_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
